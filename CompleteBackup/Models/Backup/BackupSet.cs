...
namespace CompleteBackup.Models.backup
{
    public abstract class BackupSet
    {
       ...
       BackupSet() { }
        public BackupSet(List<string> sourcePath, string currSetPath, IStorageInterface storageInterface, GenericStatusBarView progressBar)
        {
        ...
        public abstract string BackUpSetSignature { get; }
